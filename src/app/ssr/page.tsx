...
export default async function Home() {
  ...
  const [nftQuery, claimCondition1155, claimCondition721, claimCondition20] =
    await Promise.all([ 
      ...
      isERC1155Query ? getActiveClaimCondition1155({ contract, tokenId }) : undefined,
      isERC721Query ? getActiveClaimCondition721({ contract }) : undefined,
      !isERC1155Query && !isERC721Query ? getActiveClaimCondition20({ contract }) : undefined,
    ]);
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* Ensure the background video is styled properly */}
      <video
        autoPlay
        loop
        muted
